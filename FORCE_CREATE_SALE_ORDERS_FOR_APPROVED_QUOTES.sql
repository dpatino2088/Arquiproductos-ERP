-- ====================================================
-- Script: Force Create Sale Orders for Approved Quotes
-- ====================================================
-- This script manually creates SaleOrders for all approved Quotes
-- that don't have one yet. Run this to fix existing data.
-- ====================================================
...
BEGIN
    ...
    LOOP
        BEGIN
            ...
            -- Create SaleOrderLines for each QuoteLine
            v_line_number := 1;
            ...
            LOOP
                -- Check if SaleOrderLine already exists
    ...
    ELSE
        RAISE NOTICE '✅ Successfully created % SaleOrder(s) for approved Quotes.', v_count;
    END IF;
    
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '❌ Fatal error in script: %', SQLERRM;
        RAISE WARNING '❌ SQL State: %', SQLSTATE;
        RAISE;
END;
$$;
