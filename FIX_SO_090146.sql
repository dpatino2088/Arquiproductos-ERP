...
BEGIN
    ...
    FROM "SalesOrders"
    WHERE sale_order_no = 'SO-090146'
    AND deleted = false;
    
    IF v_so_id IS NULL THEN
        RAISE NOTICE '❌ SO-090146 no encontrado';
        RETURN;
    END IF;
    ...
    LOOP
        ...
        FOR v_component IN
            SELECT qlc.*, ci.item_name, ci.sku
    ...
    RAISE NOTICE '✅ Componentes: %', v_total;
END;
$$;
