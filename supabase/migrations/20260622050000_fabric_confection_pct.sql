-- ============================================================================
-- Add confection_pct to FabricRules
-- Applies a surcharge to the fabric/roll unit cost per product style.
-- e.g., Drapery Wave 2.0 with confection_pct = 0.10 means fabric cost * 1.10
--
-- This does NOT affect the global labor_pct (CostSettings), which continues
-- to apply on top of ALL costs (roll + bom + accessories) as before.
-- ============================================================================

ALTER TABLE "FabricRules" ADD COLUMN IF NOT EXISTS confection_pct numeric NOT NULL DEFAULT 0;

-- ============================================================================
-- build_bom_preview_snapshot — apply confection_pct to roll unit_cost
-- Changes vs previous version:
--   + v_confection_pct variable
--   + Lookup confection_pct from matching FabricRule
--   + v_roll_total_cost *= (1 + v_confection_pct)
--   + confection_pct stored in fabric_calc, meta, and totals for auditability
-- ============================================================================
...
BEGIN
  ...
  IF v_cp.roll_catalog_item_id IS NOT NULL THEN
    ...
    -- Apply confection surcharge to fabric unit cost
