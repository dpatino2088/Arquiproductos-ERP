...
CREATE POLICY "mo_attachments_storage_select"
  ...
  USING (bucket_id = 'mo-attachments');
...
CREATE POLICY "mo_attachments_storage_insert"
  ...
  WITH CHECK (bucket_id = 'mo-attachments');

DROP POLICY IF EXISTS "mo_attachments_storage_update" ON storage.objects;
CREATE POLICY "mo_attachments_storage_update"
