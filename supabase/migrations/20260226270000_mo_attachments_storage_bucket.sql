...
-- catalog-images often allows only images; this bucket allows PDF + images so MO attachments work.
...
-- RLS policies so authenticated users can read/upload/delete in this bucket.
