-- ============================================================================
-- Enforce SO line integrity for MO creation
-- - Prevent creating Manufacturing Orders from Sales Orders with zero active lines.
-- - When sales_order_line_id is not provided, auto-pick the first active SO line.
-- ============================================================================
...
BEGIN
  ...
  -- Resolve source SO line (required for valid BOM/material flow).
