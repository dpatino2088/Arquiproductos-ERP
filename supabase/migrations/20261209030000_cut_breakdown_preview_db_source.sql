-- ============================================================================
-- DB Source of Truth for cut breakdown preview (template-side)
-- ----------------------------------------------------------------------------
-- Goal:
-- - Keep breakdown logic in DB (same rule family used by Work Order breakdown).
-- - Provide a preview RPC for BOM Template editor without frontend formulas.
-- ============================================================================
...
IS 'Template-side cut breakdown preview using DB source-of-truth logic.';
