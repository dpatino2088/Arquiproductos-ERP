...
BEGIN
    ...
    -- STEP 3: Auto-create MO Lines from SaleOrderLines
    ...
    LOOP
        ...
        -- 5c: Soft-delete existing BOM for this SOL
        ...
        -- 5e: Try ConfiguredProducts.bom_preview_snapshot FIRST
            ...
            LOOP
                ...
                IF v_unit_cost_exw > 0 THEN
                    ...
                    BEGIN
                        ...
                        v_unit_msrp := v_msi / (1 - (v_max_discount_pct / 100.0));
                    ...
                    LOOP
                        ...
                        IF v_unit_cost_exw > 0 THEN
                            ...
                            BEGIN
                                ...
                                v_unit_msrp := v_cmsi / (1 - (v_max_discount_pct / 100.0));
                                v_total_msrp := v_unit_msrp * v_item_qty;
                            END;
                        ELSE v_unit_msrp := 0; v_total_msrp := 0;
                        END IF;
            ...
            LOOP
                ...
                IF v_unit_cost_exw > 0 THEN
                    ...
                    BEGIN
                        ...
                        v_unit_msrp := v_lcmsi / (1 - (v_max_discount_pct / 100.0));
