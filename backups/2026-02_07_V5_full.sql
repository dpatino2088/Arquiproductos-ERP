...
CREATE POLICY "proposals_delete" ON "public"."Proposals" FOR DELETE USING (((("organization_id" IS NOT NULL) AND "public"."is_org_member"("organization_id")) OR (("dealer_id" IS NOT NULL) AND "public"."is_dealer_portal_user_with_write"("dealer_id"))));



CREATE POLICY "proposals_insert" ON "public"."Proposals" FOR INSERT WITH CHECK (((("organization_id" IS NOT NULL) AND "public"."is_org_member"("organization_id")) OR (("dealer_id" IS NOT NULL) AND "public"."is_dealer_portal_user_with_write"("dealer_id"))));



CREATE POLICY "proposals_select" ON "public"."Proposals" FOR SELECT USING (((("organization_id" IS NOT NULL) AND "public"."is_org_member"("organization_id")) OR (("dealer_id" IS NOT NULL) AND "public"."is_dealer_portal_user"("dealer_id"))));



CREATE POLICY "proposals_update" ON "public"."Proposals" FOR UPDATE USING (((("organization_id" IS NOT NULL) AND "public"."is_org_member"("organization_id")) OR (("dealer_id" IS NOT NULL) AND "public"."is_dealer_portal_user_with_write"("dealer_id")))) WITH CHECK (((("organization_id" IS NOT NULL) AND "public"."is_org_member"("organization_id")) OR (("dealer_id" IS NOT NULL) AND "public"."is_dealer_portal_user_with_write"("dealer_id"))));
