...
COMMENT ON FUNCTION "public"."recompute_catalogitems_msrp_for_category"("p_org_id" "uuid", "p_category_id" "uuid") IS 'Recompute CatalogItemsMSRP for a category (trigger on CategoryMargins). Uses msrp_pct.';
