-- ============================================================================
-- FIX COMPLETO: generate_bom_from_slots - Todas las correcciones
-- ============================================================================
-- Fecha: 2026-01-20
-- Objetivo: Corregir todas las referencias a columnas inexistentes
-- ============================================================================

-- 1) PRIMERO: Agregar columnas organization_id y deleted a BOMInstanceLines
-- Ejecutar: database/migrations/20260120_add_columns_to_bominstancelines.sql

-- 2) Reemplazar función generate_bom_from_slots con todas las correcciones
...
-- ✅ Removida referencia a v_slot.uom (BOMTemplateSlots NO tiene esa columna)
-- ✅ UOM se obtiene desde CatalogItem.uom o default 'ea'
-- ✅ Usa unit_cost_exw (no unit_cost) según esquema real
-- ✅ Mantiene organization_id y deleted (se agregarán con migration previa)
