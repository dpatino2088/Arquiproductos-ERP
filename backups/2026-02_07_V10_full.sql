...
CREATE POLICY "dircontacts_select" ON "public"."DirectoryContacts" FOR SELECT TO "authenticated" USING ((("deleted" = false) AND ("organization_id" IS NOT NULL) AND ("public"."is_org_user_member"("organization_id") OR (("public"."current_dealer_id"("organization_id") IS NOT NULL) AND ("dealer_id" = "public"."current_dealer_id"("organization_id"))))));



CREATE POLICY "dircontacts_update" ON "public"."DirectoryContacts" FOR UPDATE TO "authenticated" USING ((("deleted" = false) AND ((("organization_id" IS NOT NULL) AND "public"."is_org_user_member"("organization_id")) OR (("organization_id" IS NOT NULL) AND ("public"."current_dealer_id"("organization_id") IS NOT NULL) AND ("dealer_id" = "public"."current_dealer_id"("organization_id")))))) WITH CHECK ((("organization_id" IS NOT NULL) AND ("public"."is_org_user_member"("organization_id") OR (("public"."current_dealer_id"("organization_id") IS NOT NULL) AND (("dealer_id" IS NULL) OR ("dealer_id" = "public"."current_dealer_id"("organization_id")))))));
...
CREATE POLICY "dircustomers_select" ON "public"."DirectoryCustomers" FOR SELECT TO "authenticated" USING ((("deleted" = false) AND ((("organization_id" IS NOT NULL) AND "public"."is_org_user_member"("organization_id")) OR (("organization_id" IS NOT NULL) AND ("public"."current_dealer_id"("organization_id") IS NOT NULL) AND ("dealer_id" = "public"."current_dealer_id"("organization_id"))))));



CREATE POLICY "dircustomers_update" ON "public"."DirectoryCustomers" FOR UPDATE TO "authenticated" USING ((("deleted" = false) AND ((("organization_id" IS NOT NULL) AND "public"."is_org_user_member"("organization_id")) OR (("organization_id" IS NOT NULL) AND ("public"."current_dealer_id"("organization_id") IS NOT NULL) AND ("dealer_id" = "public"."current_dealer_id"("organization_id")))))) WITH CHECK ((("organization_id" IS NOT NULL) AND ("public"."is_org_user_member"("organization_id") OR (("public"."current_dealer_id"("organization_id") IS NOT NULL) AND (("dealer_id" IS NULL) OR ("dealer_id" = "public"."current_dealer_id"("organization_id")))))));
