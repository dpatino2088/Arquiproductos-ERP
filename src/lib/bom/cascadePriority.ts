...
export const CASCADE_PRIORITY: Record<string, CascadePriorityEntry> = {
  ...
  bracket:         { order: 80, axis: null, defaultDependsOn: null,  label: '⑨ Edge Bracket (L/R)' },
  end_cap:         { order: 80, axis: null, defaultDependsOn: null,  label: '⑨ End Cap' },
  idler:           { order: 80, axis: null, defaultDependsOn: null,  label: '⑨ Idler' },
  intermediate_bracket: { order: 82, axis: null, defaultDependsOn: null, label: '⑨ Intermediate Bracket (N−1)' },
  intermediate_connector: { order: 83, axis: null, defaultDependsOn: null, label: '⑨ Intermediate Connector' },
  ...
  mounting_clip:   { order: 86, axis: null, defaultDependsOn: null,  label: '⑩ Mounting Clip (spacing)' },
