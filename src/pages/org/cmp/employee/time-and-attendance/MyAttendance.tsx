...
export default function MyAttendance() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">My Attendance</h1>
        <p className="text-xs text-muted-foreground">View and manage your attendance records</p>
      </div>
