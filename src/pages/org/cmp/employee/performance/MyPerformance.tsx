...
export default function MyPerformance() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">My Performance</h1>
        <p className="text-xs text-muted-foreground">Track and manage your personal performance goals and reviews</p>
      </div>
