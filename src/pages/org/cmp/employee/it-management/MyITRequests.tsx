...
export default function MyITRequests() {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">My IT Requests</h1>
        <p className="text-xs text-muted-foreground">Submit and track your IT support requests</p>
      </div>
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <div className="mb-4">
            <Laptop className="w-16 h-16 text-muted-foreground mx-auto" />
          </div>
