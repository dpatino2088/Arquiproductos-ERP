...
export default function MentalHealth() {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">Mental Health</h1>
        <p className="text-xs text-muted-foreground">Resources and tools for mental wellness</p>
      </div>
