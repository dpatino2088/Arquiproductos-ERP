...
export default function DocumentsAndFiles() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">Documents & Files</h1>
        <p className="text-xs text-muted-foreground">Access company documents, files, and resources</p>
      </div>
