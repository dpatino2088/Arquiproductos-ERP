...
export default function ProcessesAndPolicies() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">Processes & Policies</h1>
        <p className="text-xs text-muted-foreground">Access company processes, policies, and procedures</p>
      </div>
