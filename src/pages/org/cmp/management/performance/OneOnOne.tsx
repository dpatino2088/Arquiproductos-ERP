...
export default function OneOnOne() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">One-on-One</h1>
        <p className="text-xs text-muted-foreground">Schedule and manage one-on-one meetings</p>
      </div>
