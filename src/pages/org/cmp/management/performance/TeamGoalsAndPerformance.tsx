...
export default function TeamGoalsAndPerformance() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">Team Goals & Performance</h1>
        <p className="text-xs text-muted-foreground">Set and track team goals and performance metrics</p>
      </div>
