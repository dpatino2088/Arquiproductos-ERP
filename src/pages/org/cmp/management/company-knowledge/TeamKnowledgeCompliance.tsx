...
export default function TeamKnowledgeCompliance() {
  const { registerSubmodules } = useSubmoduleNav();

  useEffect(() => {
    // Register submodule tabs for Company Knowledge
    registerSubmodules('Company Knowledge', [
      { id: 'about-company', label: 'About the Company', href: '/management/company-knowledge/about-the-company', icon: Building2 },
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-foreground mb-1">Team Knowledge Compliance</h1>
        <p className="text-xs text-muted-foreground">Monitor and ensure team knowledge compliance</p>
      </div>
