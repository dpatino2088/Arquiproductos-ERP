          ...
          <div className="grid grid-cols-12 gap-x-4 gap-y-3">
            ...
            <div className="col-span-12 grid grid-cols-12 gap-x-4 gap-y-3">
              <div className="col-span-6">
                <Label htmlFor="vendor_name" required>Vendor Name</Label>
                <Input id="vendor_name" name="vendor_name" className="h-9" />
              </div>
            ...
            <div className="col-span-12 grid grid-cols-12 gap-x-4 gap-y-3">
              ...
              <div className="col-span-3">
                ...
                <Input id="work_phone" name="work_phone" type="tel" className="h-9" />
              </div>
              <div className="col-span-3">
            ...
            <div className="col-span-12 mt-4">
              <div className="grid grid-cols-12 gap-x-4 gap-y-3">
                ...
                <div className="col-span-3">
                  ...
                  <Input id="vendor_id" name="vendor_id" className="h-9" disabled />
                </div>
              </div>
            </div>
          </div>
