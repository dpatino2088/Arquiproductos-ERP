...
export default function Unauthorized() {
  ...
  const handleLogin = () => {
    // Redirect to login page or refresh auth
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        {/* 401 Illustration */}
        <div className="mb-8">
          <div className="text-6xl font-bold text-primary mb-4">401</div>
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mb-6">
            You don't have permission to access this resource. Please log in with valid credentials or contact your administrator if you believe this is an error.
          </p>
        </div>
        ...
        <div className="mb-8 space-y-3">
          <button
            ...
            aria-label="Log in to access this resource"
          >
        ...
        <div className="p-4 bg-muted rounded-lg">
          ...
          <p className="text-xs text-muted-foreground">
            This resource requires valid authentication. Please ensure you're logged in with the correct account.
          </p>
        </div>
