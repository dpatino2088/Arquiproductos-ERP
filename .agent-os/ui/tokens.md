...
@layer base {
  :root {
    ...
    --teal-brand-hex: var(--teal-700);        /* Primary brand - Teal 700 */
    --teal-600-hex: var(--teal-600);          /* Management view - Teal 600 (better contrast on dark sidebar) */
    --teal-brand-rgba-10: rgba(15, 118, 110, 0.1);
    --graphite-black-hex: var(--gray-900);
    --white-hex: var(--gray-50);

    /* Navigation positioning constants */
    --sidebar-icon-position: 17px;            /* Icons positioned 17px from left border (3px border + 14px padding) */
    --logo-position: 13px;                    /* Logo positioned 13px from left border */
    --brand-text-position: 52px;              /* Brand text positioned 52px from left border */
  }
