-- ====================================================
-- Fix: Actualizar función convert_quote_to_sale_order
-- ====================================================
-- Esta función usa "SaleOrders" (sin 's') pero la tabla se llama "SalesOrders" (con 's')
-- ====================================================
...
BEGIN
    ...
    -- FIXED: Cambiado de "SaleOrders" a "SalesOrders"
    ...
    LOOP
        ...
        -- FIXED: Cambiado de "SaleOrderLines" a "SalesOrderLines"
...
'Converts an approved Quote to a Sale Order with status Draft. Uses SalesOrders and SalesOrderLines tables (with "s"). Returns the new Sale Order ID. If a Sale Order already exists for this Quote (created by trigger), returns the existing ID.';
