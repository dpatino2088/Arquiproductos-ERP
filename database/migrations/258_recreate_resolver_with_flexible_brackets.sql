-- ====================================================
-- Migration 258: Recreate Resolver with Flexible Bracket Search
-- ====================================================
-- Recreates resolve_bom_role_to_sku() with flexible bracket search
-- and product type filtering
-- ====================================================
...
COMMENT ON FUNCTION public.resolve_bom_role_to_sku IS 
    'Deterministically resolves a BOM role to a concrete CatalogItem SKU based on configuration fields. Includes flexible bracket search and product type filtering to exclude SKUs from other product types.';
