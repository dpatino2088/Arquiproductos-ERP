-- ====================================================
-- Migration: Create SaleOrders and SaleOrderLines Tables
-- ====================================================
-- This migration creates tables for Sale Orders, which are created from approved Quotes
-- ====================================================
...
-- ====================================================
-- STEP 1: Create SaleOrders table
-- ====================================================
...
-- ====================================================
-- STEP 2: Create SaleOrderLines table
-- ====================================================

CREATE TABLE IF NOT EXISTS "SaleOrderLines" (
    -- Primary key
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
