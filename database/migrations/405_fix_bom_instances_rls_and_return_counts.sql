-- ====================================================
-- Migration 405: Fix BomInstances/BomInstanceLines RLS and Return Counts
-- ====================================================
-- 1. Fixes RLS policies for BomInstances and BomInstanceLines
-- 2. Updates generate_bom_for_manufacturing_order to return counts
-- ====================================================

SET search_path = public;

-- ====================================================
-- STEP 1: Enable RLS on BomInstances and BomInstanceLines (if not already enabled)
-- ====================================================
ALTER TABLE "BomInstances" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "BomInstanceLines" ENABLE ROW LEVEL SECURITY;

-- ====================================================
-- STEP 2: Drop existing policies if they exist
-- ====================================================
DROP POLICY IF EXISTS "bom_instances_select_own_org" ON "BomInstances";
DROP POLICY IF EXISTS "bom_instances_insert_own_org" ON "BomInstances";
DROP POLICY IF EXISTS "bom_instances_update_own_org" ON "BomInstances";
DROP POLICY IF EXISTS "bom_instances_delete_own_org" ON "BomInstances";

DROP POLICY IF EXISTS "bom_instance_lines_select_own_org" ON "BomInstanceLines";
DROP POLICY IF EXISTS "bom_instance_lines_insert_own_org" ON "BomInstanceLines";
DROP POLICY IF EXISTS "bom_instance_lines_update_own_org" ON "BomInstanceLines";
DROP POLICY IF EXISTS "bom_instance_lines_delete_own_org" ON "BomInstanceLines";

-- ====================================================
-- STEP 3: Create RLS Policies for BomInstances
-- ====================================================

-- SELECT: Users can see BomInstances for their organization
CREATE POLICY "bom_instances_select_own_org"
    ON "BomInstances"
    FOR SELECT
    TO authenticated
    USING (
...
-- INSERT: RPC functions can insert (via SECURITY DEFINER)
CREATE POLICY "bom_instances_insert_own_org"
    ON "BomInstances"
    FOR INSERT
    TO authenticated
    WITH CHECK (
...
-- UPDATE: Users can update BomInstances for their organization
CREATE POLICY "bom_instances_update_own_org"
    ON "BomInstances"
    FOR UPDATE
    TO authenticated
    USING (
...
-- DELETE: Users can soft-delete BomInstances for their organization
CREATE POLICY "bom_instances_delete_own_org"
    ON "BomInstances"
    FOR DELETE
    TO authenticated
    USING (
...
-- ====================================================
-- STEP 4: Create RLS Policies for BomInstanceLines
-- ====================================================

-- SELECT: Users can see BomInstanceLines for their organization
CREATE POLICY "bom_instance_lines_select_own_org"
    ON "BomInstanceLines"
    FOR SELECT
    TO authenticated
    USING (
...
-- INSERT: RPC functions can insert (via SECURITY DEFINER)
CREATE POLICY "bom_instance_lines_insert_own_org"
    ON "BomInstanceLines"
    FOR INSERT
    TO authenticated
    WITH CHECK (
...
-- UPDATE: Users can update BomInstanceLines for their organization
CREATE POLICY "bom_instance_lines_update_own_org"
    ON "BomInstanceLines"
    FOR UPDATE
    TO authenticated
    USING (
...
-- DELETE: Users can soft-delete BomInstanceLines for their organization
CREATE POLICY "bom_instance_lines_delete_own_org"
    ON "BomInstanceLines"
    FOR DELETE
    TO authenticated
    USING (
...
-- ====================================================
-- STEP 5: Update generate_bom_for_manufacturing_order to return counts
-- ====================================================
