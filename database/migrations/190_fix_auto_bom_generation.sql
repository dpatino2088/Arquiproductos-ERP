-- ====================================================
-- Migration: Fix automatic BOM generation on quote approval
-- ====================================================
-- This migration updates on_quote_approved_create_operational_docs
-- to automatically generate QuoteLineComponents if they don't exist
-- and the QuoteLine has a product_type_id
-- ====================================================
...
COMMENT ON FUNCTION public.on_quote_approved_create_operational_docs IS 
    'Trigger function that creates SaleOrder, SaleOrderLines, BomInstances, and BomInstanceLines when a Quote is approved. Automatically generates QuoteLineComponents if they don''t exist and product_type_id is available. Re-entrant: creates only missing pieces.';
