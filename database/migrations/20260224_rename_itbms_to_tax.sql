-- ============================================================
-- Migration: Rename ITBMS to Tax (columns and recalc_proposal_totals)
-- ============================================================
-- CostSettings.itbms_pct → tax_pct
-- Proposals.itbms_amount → tax_amount, exempt_itbms → exempt_tax
-- Quotes.exempt_itbms → exempt_tax
-- recalc_proposal_totals: use tax_* names; trigger includes exempt_tax
-- ============================================================
...
-- 2. Proposals (no itbms_pct column in Proposals)
...
-- 4. recalc_proposal_totals: use tax_* names
...
-- 5. Trigger: include exempt_tax so recalc runs when Exempt Tax is toggled
