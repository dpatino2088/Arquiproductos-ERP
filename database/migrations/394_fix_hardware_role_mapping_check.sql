-- ====================================================
-- Migration 394: Fix Hardware Role Mapping Check
-- ====================================================
-- BUG: bom_readiness_report was checking role mappings too strictly.
-- If ComponentRoleMap has sub_role = NULL (generic mapping), it should
-- accept components with ANY sub_role value (e.g., 'adapter', 'end_cap').
-- 
-- Previous logic only accepted:
-- 1. Exact sub_role match
-- 2. Both NULL
-- 
-- Fixed logic now accepts:
-- 1. Exact sub_role match
-- 2. Mapping has sub_role = NULL (generic, accepts any component sub_role)
-- ====================================================
...
COMMENT ON FUNCTION public.bom_readiness_report(uuid) IS 'Reports BOM readiness status for all ProductTypes in an organization. Fixed in migration 394 to accept generic mappings (sub_role = NULL) for any component sub_role.';
