-- ====================================================
-- Migration 376: Create BOM Readiness Report Function
-- ====================================================
-- Creates a comprehensive function to analyze BOM readiness
-- for all ProductTypes in an organization
--
-- Date: 2025-01-01
-- ====================================================
...
BEGIN
    ...
    LOOP
        ...
        IF v_template_count = 0 THEN
            ...
            v_suggested_seeds := v_suggested_seeds || jsonb_build_object(
                ...
                'sql', format(
                    ...
                    p_organization_id, v_product_type.id, 
        ...
        v_result := v_result || v_product_type_result;
    END LOOP;
