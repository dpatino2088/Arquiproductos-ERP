-- ====================================================
-- Migration 300: Force create SalesOrderLines for SO-090154
-- ====================================================
-- Verifies QuoteLines exist and creates SalesOrderLines
-- ====================================================

-- First, verify QuoteLines exist
SELECT 
    ...
    LOOP
        ...
        BEGIN
            INSERT INTO "SalesOrderLines" (
                ...
                COALESCE(v_quote_line_record.unit_cost_snapshot, 0),
        ...
        EXCEPTION
            WHEN OTHERS THEN
                ...
                RAISE WARNING '  ❌ Error creating SalesOrderLine for QuoteLine %: %', 
                    v_quote_line_record.id, v_error_message;
        END;
    END LOOP;
