-- ====================================================
-- Migration 334: Fix Trigger - Add catalog_item_id
-- ====================================================
-- Corrige el trigger para incluir catalog_item_id (requerido)
-- ====================================================
...
BEGIN
    ...
    LOOP
        ...
        IF NOT FOUND THEN
            ...
            -- Create SalesOrderLine (con catalog_item_id - REQUERIDO)
            BEGIN
                INSERT INTO "SalesOrderLines" (
                    sale_order_id,
                    quote_line_id,
                    line_number,
                    catalog_item_id,  -- ✅ CRITICAL: catalog_item_id is required
                    qty,
                    width_m,
                    height_m,
                    area,
                    ...
                    v_line_number,
                    v_quote_line_record.catalog_item_id,  -- ✅ CRITICAL
