-- ====================================================
-- Migration 224: Fix table name in on_quote_approved_create_operational_docs
-- ====================================================
-- The function was using "SaleOrders" but the table is "SalesOrders" (with 's')
-- This fixes the INSERT and SELECT statements to use the correct table name
-- ====================================================

BEGIN;

-- Replace the function with correct table name
...
BEGIN
    ...
    -- ⚠️ FIX: Changed from "SaleOrders" to "SalesOrders"
    ...
    IF NOT FOUND THEN
        ...
        INSERT INTO "SalesOrders" (
            ...
            NEW.created_by,
            NEW.updated_by,
            false  -- Explicitly set deleted = false
...
COMMENT ON FUNCTION public.on_quote_approved_create_operational_docs IS 
    'Trigger function that creates SalesOrder, SalesOrderLines, BomInstances, and BomInstanceLines when a Quote is approved. Automatically generates QuoteLineComponents if they don''t exist and product_type_id is available. Re-entrant: creates only missing pieces. Fixed table name from "SaleOrders" to "SalesOrders".';
