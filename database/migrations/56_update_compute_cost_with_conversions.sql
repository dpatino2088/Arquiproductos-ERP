-- ====================================================
-- Migration: Update compute_quote_line_cost to use CatalogItemConversions
-- ====================================================
-- This migration updates compute_quote_line_cost to:
-- 1. Use CatalogItemConversions (cost_exw_per_m, cost_exw_per_m2, cost_exw_per_ea)
-- 2. Respect roll_pricing_mode for rolls
-- 3. Support pack/set via cost_exw_per_ea
-- 4. Maintain backward compatibility with existing quotes
-- ====================================================
...
COMMENT ON FUNCTION compute_quote_line_cost IS 'Calculates quote line costs with CatalogItemConversions support. Uses cost_exw_per_m/m2/ea based on roll_pricing_mode and measure_basis. Supports pack/set via cost_exw_per_ea. Maintains backward compatibility.';
