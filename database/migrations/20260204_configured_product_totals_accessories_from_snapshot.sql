-- ============================================================================
-- Migration: Calculate and persist accessories_total from config_snapshot
-- Date: 2026-02-04
-- Description: In calculate_configured_product_totals, compute accessories_total
--              from config_snapshot->'accessories' (array of { id, name, qty, price })
--              and persist it in the UPDATE so ConfiguredProducts.accessories_total is set.
-- ============================================================================
...
'Recalculates ConfiguredProduct totals (roll, BOM, labor, accessories, total_msrp) and persists them. accessories_total is computed from config_snapshot->accessories (array of { id, name, qty, price }) when present.';
