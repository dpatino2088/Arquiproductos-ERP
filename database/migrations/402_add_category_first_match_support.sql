-- ====================================================
-- Migration 402: Add CATEGORY_FIRST_MATCH support to resolve_auto_select_sku
-- ====================================================
-- Adds support for CATEGORY_FIRST_MATCH sku_resolution_rule
-- This rule selects the first available item in the category without considering hardware_color
-- ====================================================
