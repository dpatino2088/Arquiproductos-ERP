-- ============================================================================
-- FIX: Remover referencia a slots.deleted en generate_bom_from_slots
-- ============================================================================
-- Error: "column slots.deleted does not exist"
-- Causa: BOMTemplateSlots NO tiene columna "deleted"
-- ============================================================================

-- Reemplazar la función completa sin la referencia a deleted en BOMTemplateSlots
...
-- También necesitamos corregir select_best_bom_template_for_quote_line
