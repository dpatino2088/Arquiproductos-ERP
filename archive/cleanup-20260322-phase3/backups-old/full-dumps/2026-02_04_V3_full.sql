...
COMMENT ON FUNCTION "public"."build_bom_preview_snapshot"("p_org_id" "uuid", "p_configured_product_id" "uuid", "p_bom_template_id" "uuid") IS 'Builds the bom_preview_snapshot JSONB for a ConfiguredProduct. Called after totals are calculated.';
...
CREATE OR REPLACE FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid" DEFAULT NULL::"uuid", "p_position" "text" DEFAULT NULL::"text", "p_area" "text" DEFAULT NULL::"text") RETURNS TABLE("quote_line_id" "uuid", "bom_instance_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  IF v_snapshot->>'version' = '1'
     AND v_snapshot_totals IS NOT NULL
     AND (v_snapshot_totals->>'total_msrp')::numeric > 0
  THEN
    ...
    v_total_msrp      := (v_snapshot_totals->>'total_msrp')::numeric;
  END IF;
  ...
  RETURN QUERY
  SELECT v_quote_line_id, NULL::uuid;
END;
$$;


ALTER FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text") IS 'RPC oficial para crear QuoteLine desde ConfiguredProduct.

✅ FIX 2026-02-04: Recalcula totales automáticamente si snapshot y columnas están en 0,
evitando que QuoteLines se creen con msrp = 0.
...
Si ambos están en 0, llama calculate_configured_product_totals automáticamente.';



CREATE OR REPLACE FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid" DEFAULT NULL::"uuid", "p_position" "text" DEFAULT NULL::"text", "p_area" "text" DEFAULT NULL::"text", "p_fabric_drop" "text" DEFAULT NULL::"text", "p_installation_type" "text" DEFAULT NULL::"text", "p_installation_location" "text" DEFAULT NULL::"text") RETURNS TABLE("quote_line_id" "uuid", "bom_instance_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text", "p_fabric_drop" "text", "p_installation_type" "text", "p_installation_location" "text") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text", "p_fabric_drop" "text", "p_installation_type" "text", "p_installation_location" "text") IS 'Creates QuoteLine from ConfiguredProduct. Sets unit_msrp (unit price) and msrp (line total). UI reads these only; no client-side calculation.';
...
COMMENT ON FUNCTION "public"."create_configured_product_and_bom_preview"("p_org_id" "uuid", "p_product_type_id" "uuid", "p_config_snapshot" "jsonb", "p_quote_id" "uuid", "p_quote_line_id" "uuid") IS 'Creates ConfiguredProduct with pricing totals and bom_preview_snapshot.
...
GRANT ALL ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text", "p_fabric_drop" "text", "p_installation_type" "text", "p_installation_location" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text", "p_fabric_drop" "text", "p_installation_type" "text", "p_installation_location" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."commit_configured_product_to_quote_line"("p_org_id" "uuid", "p_quote_id" "uuid", "p_configured_product_id" "uuid", "p_company_id" "uuid", "p_position" "text", "p_area" "text", "p_fabric_drop" "text", "p_installation_type" "text", "p_installation_location" "text") TO "service_role";
