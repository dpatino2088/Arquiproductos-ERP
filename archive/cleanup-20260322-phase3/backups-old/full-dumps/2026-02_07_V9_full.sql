...
CREATE POLICY "directory_contacts_delete" ON "public"."DirectoryContacts" FOR DELETE USING ((("organization_id" = "public"."current_app_user_org_id"()) AND (("public"."current_app_user_type"() = 'org'::"text") OR ("dealer_id" = "public"."current_app_user_dealer_id"()))));



CREATE POLICY "directory_contacts_insert" ON "public"."DirectoryContacts" FOR INSERT WITH CHECK ((("organization_id" = "public"."current_app_user_org_id"()) AND (("public"."current_app_user_type"() = 'org'::"text") OR ("dealer_id" = "public"."current_app_user_dealer_id"()))));



CREATE POLICY "directory_contacts_select" ON "public"."DirectoryContacts" FOR SELECT USING ((("organization_id" = "public"."current_app_user_org_id"()) AND (("public"."current_app_user_type"() = 'org'::"text") OR ("dealer_id" = "public"."current_app_user_dealer_id"())) AND (COALESCE("deleted", false) = false)));



CREATE POLICY "directory_contacts_update" ON "public"."DirectoryContacts" FOR UPDATE USING ((("organization_id" = "public"."current_app_user_org_id"()) AND (("public"."current_app_user_type"() = 'org'::"text") OR ("dealer_id" = "public"."current_app_user_dealer_id"())) AND (COALESCE("deleted", false) = false))) WITH CHECK ((("organization_id" = "public"."current_app_user_org_id"()) AND (("public"."current_app_user_type"() = 'org'::"text") OR ("dealer_id" = "public"."current_app_user_dealer_id"()))));



CREATE POLICY "directorycontacts_dealer_insert" ON "public"."DirectoryContacts" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "directorycontacts_dealer_select" ON "public"."DirectoryContacts" FOR SELECT USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "directorycontacts_dealer_update" ON "public"."DirectoryContacts" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id"))))) WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "directorycontacts_org_insert" ON "public"."DirectoryContacts" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "directorycontacts_org_select" ON "public"."DirectoryContacts" FOR SELECT USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "directorycontacts_org_update" ON "public"."DirectoryContacts" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL))) WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "directorycustomers_dealer_insert" ON "public"."DirectoryCustomers" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "directorycustomers_dealer_select" ON "public"."DirectoryCustomers" FOR SELECT USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "directorycustomers_dealer_update" ON "public"."DirectoryCustomers" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id"))))) WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "directorycustomers_org_insert" ON "public"."DirectoryCustomers" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "directorycustomers_org_select" ON "public"."DirectoryCustomers" FOR SELECT USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "directorycustomers_org_update" ON "public"."DirectoryCustomers" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL))) WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));
...
CREATE POLICY "proposals_dealer_insert" ON "public"."Proposals" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "proposals_dealer_select" ON "public"."Proposals" FOR SELECT USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "proposals_dealer_update" ON "public"."Proposals" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id"))))) WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "proposals_org_insert" ON "public"."Proposals" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "proposals_org_select" ON "public"."Proposals" FOR SELECT USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "proposals_org_update" ON "public"."Proposals" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL))) WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));
...
CREATE POLICY "quotes_dealer_insert" ON "public"."Quotes" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "quotes_dealer_select" ON "public"."Quotes" FOR SELECT USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "quotes_dealer_update" ON "public"."Quotes" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id"))))) WITH CHECK ((("organization_id" IS NOT NULL) AND ("dealer_id" IS NOT NULL) AND ("dealer_id" = ANY ("public"."current_user_dealer_ids"("organization_id")))));



CREATE POLICY "quotes_org_insert" ON "public"."Quotes" FOR INSERT WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "quotes_org_select" ON "public"."Quotes" FOR SELECT USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));



CREATE POLICY "quotes_org_update" ON "public"."Quotes" FOR UPDATE USING ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL))) WITH CHECK ((("organization_id" IS NOT NULL) AND "public"."is_internal_org_user"("organization_id") AND ("dealer_id" IS NULL)));
