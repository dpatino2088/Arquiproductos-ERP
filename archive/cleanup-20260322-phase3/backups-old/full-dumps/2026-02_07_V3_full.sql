...
COMMENT ON FUNCTION "public"."recalc_proposal_totals"("p_proposal_id" "uuid") IS 'Recalculates Proposals.subtotal_amount, discount_amount, itbms_amount, total_amount. Includes ProposalLineAddOns. Discount before ITBMS.';
